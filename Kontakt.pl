...
<head>
	...
	<link rel="stylesheet" href="main_kontakt.css">
...
<body>
	<header>
		...
		<div class="container">
        <div class="row">
            <div class = "col col-md-12 justify-content-center contact">
                <h2 class ="contact-header">Kontakt</h2>    
                <div class="col col-md-6 wowload fadeInRight">
                    <h4 class="contact-header">Adres: </h4>
                    <p>
					SKOKOWNIA</br>
					ul. Skokowa 20 lok. 4</br>
					99-999 Opole
                    </p>

                    <h4>Numery telefonu:</h4>
                    <p>+48 602 120 987</p>
                    <p>+48 604 121 920</a></p>
                    <h4>Numer konta:</h4>
                    <p><u>24 2222 3333 4444 3084 7904 0001</u></p>
                </div>
                <div class="col col-md-6">
                    <h4 class="contact-header">Skontaktuj się z nami mailowo: </h4></br>
                    <form role="form" class="wowload fadeInRight">
                        ...
                        <button class="btn btn-default btn_submit"><h3>Submit</h3></button>
                    </form> 
                </div>
            </div>          
        </div>
